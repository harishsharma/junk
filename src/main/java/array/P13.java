...
public class P13 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new P13().solve(a, 30));
        System.out.println(new P13().solve(a, 3));
        System.out.println(new P13().solve(a, 0));
        System.out.println(new P13().solve(a, 11));
        System.out.println(new P13().solve(a, 20));
        System.out.println(new P13().solve(a, 440));
        System.out.println(new P13().solve(a, 23));
    }
}
