...
public class CountOccurences {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new CountOccurences().solve(a, 1));
        System.out.println(new CountOccurences().solve(a, 2));
        System.out.println(new CountOccurences().solve(a, 3));
        System.out.println(new CountOccurences().solve(a, 4));
    }
}
