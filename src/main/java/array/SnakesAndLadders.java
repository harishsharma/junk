...
/**
 * Snakes and Ladders basically do the same thing. They move the coin from one place to another if they move in positive
 * direction we call them ladders otherwise snakes.
 * 
 */
class Movers {
