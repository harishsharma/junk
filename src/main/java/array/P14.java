...
public class P14 {
    ...
    public static void main(String[] args) {
        ...
        log.debug("{}", new P14().solve(a, 10));
        log.debug("{}", new P14().solve(a, 20));
        log.debug("{}", new P14().solve(a, 3));
        log.debug("{}", new P14().solve(a, 40));
        log.debug("{}", new P14().solve(a, 50));
        log.debug("{}", new P14().solve(a, 940));
        log.debug("{}", new P14().solve(a, 90));
        log.debug("{}", new P14().solve(a, 00));
        log.debug("{}", new P14().solve(a, 9090));
    }
}
